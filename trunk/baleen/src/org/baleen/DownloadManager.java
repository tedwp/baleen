...
import org.baleen.data.Json;
import org.baleen.data.XMLHandler;
...
public class DownloadManager implements Runnable {
	...
	public DownloadManager(MixContext ctx) {
		Log.d(MixView.TAG, "Debug: DownloadManager entered");
		this.ctx = ctx;
	}

	public void run() {
		Log.d(MixView.TAG, "Debug: DownloadManager - run entered");
		String jobId;
	...
	private void sleep(long ms){
		Log.d(MixView.TAG, "Debug: DownloadManager - sleep entered");
		try {
			Thread.sleep(ms);
	...
	public synchronized void purgeLists() {
		Log.d(MixView.TAG, "Debug: DownloadManager - purgeLists entered");
		todoList.clear();
		doneList.clear();
	}

	public synchronized String submitJob(DownloadRequest job) {
		Log.d(MixView.TAG, "Debug: DownloadManager - submitJob entered");
		String jobId = "ID_" + (id++);
	...
	public synchronized DownloadResult getReqResult(String jobId) {
		Log.d(MixView.TAG, "Debug: DownloadManager - getReqResult entered");
